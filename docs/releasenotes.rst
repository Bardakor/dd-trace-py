...
You can generate a release note with the command line tool ``reno`` through the pinned uv environment::

    $ scripts/ddtest scripts/run-uv-test-env reno -- new <title-slug>
