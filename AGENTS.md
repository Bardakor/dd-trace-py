...
- Build failures and `ModuleNotFoundError` when running uv test environments
...
| `apm-integrations` | Creating or modifying contrib integrations (`ddtrace/contrib/internal/`). Covers patch module system, context_with_event, BaseLLMIntegration, streaming, testing with uv, VCR cassettes, and anti-patterns. Use when touching any integration. |
