...
PREFIX_ROOT = ROOT / ".hatch" / "test-prefixes"
BOOTSTRAP_PATH = ROOT / "scripts" / "hatch_compat"
INSTALLER_SCHEMA = b"hatch-test-env-v1"


def _dependency_prefix(metadata: dict[str, Any]) -> Path:
    python = metadata["python"]
    return PREFIX_ROOT / f"py{python}" / metadata["hash"]
