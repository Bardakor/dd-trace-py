...
# These are pydantic-ai's defaults at the pinned test versions, not caller choices or framework invariants.
# They are asserted once here; end_strategy becomes "graceful" at 2.x, so adding a 2.x pin should fail.
