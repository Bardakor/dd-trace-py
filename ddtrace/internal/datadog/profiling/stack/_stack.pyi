...
def take_sampling_thread_error() -> Optional[tuple[str, str]]:
    """Return and clear the (error_type, message) that terminated the sampling thread.

    Returns None if the sampling thread did not abort on an unexpected exception.
    """
    ...
